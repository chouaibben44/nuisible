...
const ITEMS: Item[] = [
  {
    ...
    bullets: ['Audit & plan de pose', 'Dispositifs discrets durables', 'Intervention en hauteur'],
    image: pigeonImage,
    icon: Bird,
  ...
  },
  {
    ...
    bullets: ['Traitement larvaire ciblé', 'Programme saisonnier', 'Prévention & suivi'],
    image: mosquitoImage,
    icon: Bug,
  ...
  },
  {
    ...
    bullets: ['Diagnostic & cartographie', 'Barrières certifiées', 'Traçabilité complète'],
    image: termiteImage,
    icon: ShieldCheck,
      ...
      <div className="container mx-auto px-4">
                      ...
                      <div className="overflow-hidden">
                        <div className="px-4 pb-5 pt-0 text-sm leading-relaxed text-zinc-600">
                          ...
                          <div className="mt-5">
                            ...
                            >
                              <Link to={link}>Demander un devis</Link>
                            </Button>
                          </div>
                        </div>
                      </div>
        ...
        <div className="mt-24 text-center">
          <Button size="lg" asChild className="shadow-sm hover:shadow-md">
            <Link to="/services">Découvrez tous nos services</Link>
          </Button>
        </div>
      </div>
    </section>
